...
class Checker {
    ...
    Monomial leadMonomialOfSubst(final Monomial monomial, final Monomial... monomials) throws
    ...
    private boolean isHomogeneous(final Iterable<Monomial> p) {
        int previousDeg = -1;
        int i = 0;
    ...
    private boolean areHomogeneous(final Polynomial... polynomials) {
